    ...
    public partial class CardInventoryCollectionControl : UserControl, INotifyPropertyChanged
    {
        ...
        public bool HideAddButton
        {
            ...
            set
            {
                ...
                PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(HideAddButton)));
                PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(AddButtonVisibility)));
            }
        }

        public Visibility AddButtonVisibility => _hideAddButton ? Visibility.Collapsed : Visibility.Visible;
