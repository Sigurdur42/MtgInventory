...
namespace MtgDatabase.Tests
{
    ...
    public class MkmMapperTests
    {
        ...
        public void VerifyPatchSetName(string setName, string expected)
        {
            var result = MkmMapper.PatchSetName(setName);
            Assert.AreEqual(expected, result);
        }
        
        [TestCase("Jace Beleren", "Jace-Beleren")]
        [TestCase("Jace, Arcane Strategist", "Jace-Arcane-Strategist")]  
        public void VerifyPatchCardName(string cardName, string expected)
        {
            var result = MkmMapper.PatchCardName(cardName);
            Assert.AreEqual(expected, result);
        }
    }
}